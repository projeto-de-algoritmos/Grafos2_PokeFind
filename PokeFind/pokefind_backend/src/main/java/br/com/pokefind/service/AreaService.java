...
import br.com.pokefind.dto.AreaDTO;
import br.com.pokefind.dto.AreaEcontradaDTO;
import br.com.pokefind.exception.EmptyListPokemonException;
import br.com.pokefind.exception.EmptyLocalForPokemonException;
import br.com.pokefind.model.Area;
import br.com.pokefind.model.Pokemon;
import br.com.pokefind.repository.AreaRepository;
...
public class AreaService {
    ...
    public AreaEcontradaDTO findClosestArea(Long idPokemon, Long idArea){
        ...
        try {
            ...
            throw new EmptyLocalForPokemonException("Não foi encontrados locais para este pokémon");
        }
        return dto;
    }
